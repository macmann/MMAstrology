...
const translations = {
  en: {
    "nav.home": "Home",
    "nav.dailyReading": "Daily Reading",
    "nav.lifeReading": "Life Reading",
    "nav.profileReading": "Profile Reading",
    "nav.readings": "Daily Reading",
    "nav.profile": "Profile",
    "nav.history": "History",
    ...
    "home.login": "Log in",
    "home.eyebrow": "Mobile cosmic AI",
    "home.title": "Daily astrology in your pocket.",
    "home.subtitle": "Create your birth profile, preserve conversations, and use credits from a mystical mobile-first dashboard.",
    "home.startProfile": "Start your profile",
    ...
    "login.title": "Log in",
    "login.subtitle": "Return to your cosmic dashboard, saved readings, and AI astrology conversations.",
    "login.secureProfile": "✦ Secure profile",
    "login.dailyInsights": "☽ Daily insights",
    "login.email": "Email",
    "login.emailPlaceholder": "you@stars.com",
    "login.password": "Password",
    "login.passwordPlaceholder": "Enter your password",
    "login.submitting": "Opening NatKhat AI...",
    "login.submit": "Log in to NatKhat AI",
    "login.newPrompt": "New to NatKhat AI?",
    "login.createAccount": "Create an account",
    "login.error": "Unable to log in.",
    "profile.eyebrow": "Profile settings",
    "profile.title": "Profile settings",
    "profile.subtitle": "Manage your name, password, birth profile, language, and credit balance from one settings page.",
    ...
    "readings.eyebrow": "Profile",
    "readings.title": "Your Reading",
    "readings.subtitle": "Your saved birth profile, life reading, and daily guidance for Love, Business, Health, plus general Dos and Don'ts.",
    "readings.profileEyebrow": "Birth profile",
    "readings.profileTitle": "Profile Reading",
    "readings.profileSubtitle": "Your saved birth details and one-time life reading generated from your natal context.",
    "readings.lifeEyebrow": "Life Reading",
    "readings.lifeTitle": "Life Reading",
    "readings.lifeSubtitle": "Your current birth profile, primary sun sign, and saved one-time life reading generated when your profile was first created.",
    "readings.dailyEyebrow": "Today",
    "readings.dailyTitle": "Daily Reading",
    "readings.dailySubtitle": "Your daily guidance for Love, Business, Health, plus general Dos and Don'ts.",
    "readings.unavailable": "Reading unavailable",
    "readings.openError": "We could not open your blueprint.",
    "readings.loadError": "Unable to load your reading.",
    "readings.reviewProfile": "Open profile settings",
    ...
    "readings.oneTimeReading": "Saved life reading",
    "readings.lifeReading": "Birth profile reading",
    "readings.yourReading": "Your Reading",
    "readings.todayEyebrow": "Daily guidance",
    "readings.dailyReading": "Daily Reading",
    "readings.todayLoveBusinessHealth": "Your today reading of Love, Business, Health — plus general Dos and Don'ts.",
    "readings.generatedToday": "Daily reading generated for {date}.",
    "readings.freshToday": "Fresh today",
    "readings.yourCosmicProfile": "Your cosmic profile",
    "readings.todayAtGlance": "Today at a glance",
    "readings.jumpToInsight": "Jump to an insight",
    "readings.lifeAreas": "Your life areas",
    "readings.insights": "insights",
    "readings.actionPlan": "Your action plan",
    "readings.personalizedFromProfile": "Personalized from your birth profile · {time} · {location}",
    "readings.overallSignReading": "Overall Sign Reading",
    "readings.savedOnce": "Generated once and saved on {date}.",
    ...
    "readings.aspectLove": "Love",
    "readings.aspectBusiness": "Business",
    "readings.aspectHealth": "Health",
    "readings.aspectDos": "Dos",
    "readings.aspectDonts": "Don'ts",
  ...
  my: {
    "nav.home": "ပင်မ",
    "nav.dailyReading": "နေ့စဉ် ဟောစာတမ်း",
    "nav.lifeReading": "ဘဝ ဟောစာတမ်း",
    "nav.profileReading": "ပရိုဖိုင် ဟောစာတမ်း",
    "nav.readings": "နေ့စဉ် ဟောစာတမ်း",
    ...
    "home.login": "ဝင်မည်",
    "home.eyebrow": "မိုဘိုင်း နက္ခတ် AI",
    "home.title": "နေ့စဉ် ဗေဒင်ကို သင့်လက်ထဲမှာ။",
    "home.subtitle": "သင့်မွေးဖွားမှု ပရိုဖိုင်ကို ဖန်တီးပြီး စကားဝိုင်းများကို သိမ်းဆည်းကာ မိုဘိုင်းအဓိက နက္ခတ်ဒက်ရှ်ဘုတ်မှ ခရက်ဒစ်များကို အသုံးပြုပါ။",
    "home.startProfile": "ပရိုဖိုင် စတင်မည်",
    "home.haveAccount": "အကောင့်ရှိပြီးသားပါ",
    "home.insightEyebrow": "ယနေ့ အကြံပြုချက်",
    "home.insightTitle": "Venus သည် ဆက်ဆံရေးရှင်းလင်းမှုကို မြှင့်တင်ပေးသည်။",
    "home.insightBody": "လက်ရှိနက္ခတ်သွားလာမှုများက သင့်မွေးဖွားမှု နက္ခတ်နေရာများနှင့် မည်သို့ဆုံဆည်းနေသည်ကို မေးပြီး အကောင့်အခြေပြု လမ်းညွှန်မှုကို ရယူပါ။",
    "home.freeCredits": "✦ နေ့စဉ် အခမဲ့ ခရက်ဒစ် ၄ ခု အလိုအလျောက် ပြန်လည်သတ်မှတ်ပါသည်။",
    "home.purchasedCredits": "☽ ဝယ်ယူထားသော ခရက်ဒစ်များသည် သင့်အကောင့်နှင့် ဆက်လက်ချိတ်ဆက်ထားပါသည်။",
    "home.historyMetadata": "✧ စကားဝိုင်းမှတ်တမ်းသည် provider နှင့် role အချက်အလက်များနှင့်အတူ လိုက်ပါသိမ်းဆည်းပါသည်။",
    "login.title": "ဝင်မည်",
    "login.subtitle": "သင့်နက္ခတ်ဒက်ရှ်ဘုတ်၊ သိမ်းဆည်းထားသော ဟောစာတမ်းများနှင့် AI ဗေဒင်စကားဝိုင်းများသို့ ပြန်ဝင်ပါ။",
    "login.secureProfile": "✦ လုံခြုံသော ပရိုဖိုင်",
    "login.dailyInsights": "☽ နေ့စဉ် အကြံပြုချက်များ",
    "login.email": "အီးမေးလ်",
    "login.emailPlaceholder": "you@stars.com",
    "login.password": "စကားဝှက်",
    "login.passwordPlaceholder": "သင့်စကားဝှက် ထည့်ပါ",
    "login.submitting": "NatKhat AI ဖွင့်နေသည်...",
    "login.submit": "NatKhat AI သို့ ဝင်မည်",
    "login.newPrompt": "NatKhat AI ကို အသစ်အသုံးပြုသူလား?",
    "login.createAccount": "အကောင့်ဖန်တီးမည်",
    "login.error": "ဝင်၍ မရပါ။",
    "profile.eyebrow": "ပရိုဖိုင် ဆက်တင်",
    "profile.title": "ပရိုဖိုင် ဆက်တင်",
    "profile.subtitle": "အမည်၊ စကားဝှက်၊ မွေးဖွားမှုအချက်အလက်၊ ဘာသာစကားနှင့် ခရက်ဒစ်များကို ဆက်တင်စာမျက်နှာတစ်ခုတည်းတွင် စီမံပါ။",
    ...
    "readings.eyebrow": "ပရိုဖိုင်",
    "readings.title": "သင့်ဟောစာတမ်း",
    "readings.subtitle": "သင့်သိမ်းဆည်းထားသော မွေးဖွားမှု ပရိုဖိုင်၊ ဘဝဟောစာတမ်းနှင့် အချစ်ရေး၊ စီးပွားရေး၊ ကျန်းမာရေး အပြင် အထွေထွေ လုပ်သင့်သည်များနှင့် မလုပ်သင့်သည်များ လမ်းညွှန်ချက်များ။",
    "readings.profileEyebrow": "မွေးဖွားမှု ပရိုဖိုင်",
    "readings.profileTitle": "ပရိုဖိုင် ဟောစာတမ်း",
    "readings.profileSubtitle": "သင့်မွေးဖွားမှု အချက်အလက်နှင့် နက္ခတ်အခြေအနေအပေါ် အခြေခံ၍ တစ်ကြိမ်ထုတ်ထားသော ဘဝဟောစာတမ်း။",
    "readings.lifeEyebrow": "ဘဝ ဟောစာတမ်း",
    "readings.lifeTitle": "ဘဝ ဟောစာတမ်း",
    "readings.lifeSubtitle": "သင့်လက်ရှိမွေးဖွားမှု ပရိုဖိုင်၊ အဓိက နေရาศီနှင့် ပရိုဖိုင်ပထမဆုံးဖန်တီးချိန်တွင် သိမ်းထားသော တစ်ကြိမ်သာ ဘဝဟောစာတမ်း။",
    "readings.dailyEyebrow": "ယနေ့",
    "readings.dailyTitle": "နေ့စဉ် ဟောစာတမ်း",
    "readings.dailySubtitle": "အချစ်ရေး၊ စီးပွားရေး၊ ကျန်းမာရေး အပြင် အထွေထွေ လုပ်သင့်သည်များနှင့် မလုပ်သင့်သည်များ ပါဝင်သော သင့်နေ့စဉ် လမ်းညွှန်ချက်။",
    "readings.unavailable": "ဟောစာတမ်း မရနိုင်ပါ",
    "readings.openError": "သင်၏ နက္ခတ်ပုံစံကို ဖွင့်၍ မရပါ။",
    "readings.loadError": "သင့်ဟောစာတမ်းကို ဖွင့်၍ မရပါ။",
    "readings.reviewProfile": "ပရိုဖိုင်ဆက်တင် ဖွင့်မည်",
    ...
    "readings.oneTimeReading": "သိမ်းဆည်းထားသော ဘဝဖတ်ရှုချက်",
    "readings.lifeReading": "မွေးဖွားမှုအခြေခံ ဟောစာတမ်း",
    "readings.yourReading": "သင့်ဟောစာတမ်း",
    "readings.todayEyebrow": "နေ့စဉ်လမ်းညွှန်ချက်",
    "readings.dailyReading": "နေ့စဉ်ဟောစာတမ်း",
    "readings.todayLoveBusinessHealth": "ယနေ့ သင့် အချစ်ရေး၊ စီးပွားရေး၊ ကျန်းမာရေး ဟောစာတမ်း — အထွေထွေ လုပ်သင့်သည်များနှင့် မလုပ်သင့်သည်များ ပါဝင်သည်။",
    "readings.generatedToday": "{date} အတွက် နေ့စဉ်ဟောစာတမ်း ဖန်တီးပြီးပါပြီ။",
    "readings.freshToday": "ယနေ့ အသစ်",
    "readings.yourCosmicProfile": "သင့်နက္ခတ်ပရိုဖိုင်",
    "readings.todayAtGlance": "ယနေ့ အကျဉ်းချုပ်",
    "readings.jumpToInsight": "အကြံပြုချက်သို့ သွားရန်",
    "readings.lifeAreas": "သင့်ဘဝ ကဏ္ဍများ",
    "readings.insights": "အကြံပြုချက်",
    "readings.actionPlan": "သင့်လုပ်ဆောင်မှု အစီအစဉ်",
    "readings.personalizedFromProfile": "သင့်မွေးဖွားမှု ပရိုဖိုင်မှ စိတ်ကြိုက်ဖန်တီးထားသည် · {time} · {location}",
    "readings.overallSignReading": "ရာသီခွင် ခြုံငုံဖတ်ရှုချက်",
    "readings.savedOnce": "{date} တွင် တစ်ကြိမ်သာ ဖန်တီးပြီး သိမ်းဆည်းထားသည်။",
    ...
    "readings.aspectLove": "အချစ်ရေး",
    "readings.aspectBusiness": "စီးပွားရေး",
    "readings.aspectHealth": "ကျန်းမာရေး",
    "readings.aspectDos": "လုပ်သင့်သည်များ",
    "readings.aspectDonts": "မလုပ်သင့်သည်များ",
