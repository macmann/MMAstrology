...
const translations = {
  en: {
    ...
    "login.submitting": "Opening AI Bay Din...",
    "login.submit": "Log in to AI Bay Din",
    "login.newPrompt": "New to AI Bay Din?",
  ...
  my: {
    ...
    "login.submitting": "AI Bay Din ဖွင့်နေသည်...",
    "login.submit": "AI Bay Din သို့ ဝင်မည်",
    "login.newPrompt": "AI Bay Din ကို အသစ်အသုံးပြုသူလား?",
