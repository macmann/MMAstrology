...
const translations = {
  en: {
    ...
    "login.submitting": "Opening Nat Khat AI...",
    "login.submit": "Log in to Nat Khat AI",
    "login.newPrompt": "New to Nat Khat AI?",
    ...
    "readings.subtitle": "A one-time AI overview generated from your saved birth profile, translated for your selected language, and saved so it does not refresh each visit.",
  ...
  my: {
    ...
    "login.submitting": "Nat Khat AI ဖွင့်နေသည်...",
    "login.submit": "Nat Khat AI သို့ ဝင်မည်",
    "login.newPrompt": "Nat Khat AI ကို အသစ်အသုံးပြုသူလား?",
    ...
    "readings.subtitle": "သင့်သိမ်းဆည်းထားသော မွေးဖွားမှု ပရိုဖိုင်အပေါ် အခြေခံ၍ AI က တစ်ကြိမ်သာ ဖန်တီးပြီး သင်ရွေးထားသော ဘာသာစကားအတွက် ဘာသာပြန်ကာ ထပ်မံ refresh မဖြစ်စေရန် သိမ်းဆည်းထားသော ခြုံငုံဖတ်ရှုချက်။",
