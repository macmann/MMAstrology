...
const dailyFallbacks: Record<ZodiacElement, { en: string; my: string }> = {
  ...
  Earth: {
    ...
    my: "ယနေ့ သင့် Love, Business, Health ဟောစာတမ်း\n\nLove: ကြီးမားသောကတိများထက် ယုံကြည်ရသော သေးငယ်သောလုပ်ရပ်များက ပိုပြောနိုင်သည်။ Business: သင်ယုံကြည်ပြီးသား အစီအစဉ်ပေါ်မှ တည်ဆောက်ပါ။ Health: ရိုးရှင်းသောနေ့စဉ်လုပ်ရိုးလုပ်စဉ်များက သင့်ကို တည်ငြိမ်စေပါစေ။\n\nDos: လက်ရှိအချိန်တွင် ရှိနေပြီး လက်တွေ့ကျပါ။ သင့်အချိန်ဇယားကို ကာကွယ်ပါ။ အချိန်မှန် စားပြီး အနားယူပါ။\n\nDon'ts: ထိန်းချုပ်ခြင်းကို ဂရုစိုက်ခြင်းနှင့် မရောထွေးပါနှင့်။ မမျှဝေခင် အလွန်အမင်း မပြင်ဆင်ပါနှင့်။ ဖိစီးမှုကို တိတ်တိတ်ဆိတ်ဆိတ် မသယ်ဆောင်ပါနှင့်။",
  },
  Air: {
    ...
    my: "ယနေ့ သင့် Love, Business, Health ဟောစာတမ်း\n\nLove: အမှန်တရားကို နူးညံ့စွာပြောပြီး တုံ့ပြန်ရန် နေရာချန်ထားပါ။ Business: အသုံးဝင်သော စကားဝိုင်းတစ်ခုက နောက်တစ်ဆင့်ကို ဖွင့်ပေးနိုင်သည်။ Health: အသိပေးချက်များကြားတွင် သင့်စိတ်အတွက် တိတ်ဆိတ်သောနေရာပေးပါ။\n\nDos: ပိုကောင်းသော မေးခွန်းတစ်ခုမေးပါ။ အစီအစဉ်ကို ချရေးပါ။ အလုပ်ပြောင်းမလုပ်ခင် အသက်ရှူပါ။\n\nDon'ts: ခံစားချက်များကို အလွန်အကျွံ မရှင်းပြပါနှင့်။ အာရုံကို မပြန့်ကျဲစေပါနှင့်။ ဖုန်း/စခရင်အသံများက တစ်နေ့တာကို မထိန်းချုပ်စေပါနှင့်။",
  },
  Water: {
    ...
    my: "ယနေ့ သင့် Love, Business, Health ဟောစာတမ်း\n\nLove: သင်ခံစားရသည့်အရာကို ယုံကြည်ပြီး နူးညံ့သောစကားများဖြင့် အတည်ပြုပါ။ Business: စိတ်ခံစားမှုရှင်းလင်းသော လူများနှင့်နေရာများအနီးတွင် အလုပ်လုပ်ပါ။ Health: နူးညံ့သော စည်းမျဉ်းများက သင့်စွမ်းအားကို ကာကွယ်ပေးမည်။\n\nDos: သင့်လိုအပ်ချက်ကို အေးဆေးစွာ ပြောပါ။ စိတ်မရှုပ်ထွေးဆုံး အလုပ်ကို လိုက်လုပ်ပါ။ စိတ်အေးစေသော ရိုးရာအလေ့အကျင့်များကို ရွေးပါ။\n\nDon'ts: အခြားသူတိုင်း၏ စိတ်ခံစားချက်ကို မစုပ်ယူပါနှင့်။ ပတ်ဝန်းကျင်မပြည့်စုံလို့ မရွှေ့ဆိုင်းပါနှင့်။ စိတ်ဖြေလျှော့ချိန်ကို မကျော်ပါနှင့်။",
  },
};
