...
const dailyFallbacks: Record<ZodiacElement, { en: string; my: string }> = {
  Fire: {
    en: "Your today reading of Love, Business, Health\n\nLove: Lead with warmth, but pause before reacting. Business: Choose one bold task and finish it cleanly. Health: Spend your energy in steady bursts, not one big flame.\n\nDos: Listen before you defend. Act on the clearest priority. Hydrate and stretch.\n\nDon'ts: Do not turn urgency into drama. Do not chase every idea. Do not ignore rest signals.",
    my: "ယနေ့ သင့် အချစ်ရေး၊ စီးပွားရေး၊ ကျန်းမာရေး ဟောစာတမ်း\n\nအချစ်ရေး: နွေးထွေးစွာ စတင်ပါ၊ သို့သော် တုံ့ပြန်မီ ခဏရပ်စဉ်းစားပါ။ စီးပွားရေး: ရဲရင့်သော အလုပ်တစ်ခုကို ရွေးပြီး သေချာပြီးစီးအောင်လုပ်ပါ။ ကျန်းမာရေး: စွမ်းအားကို တစ်ခါတည်းမသုံးဘဲ တည်ငြိမ်စွာ ခွဲဝေသုံးပါ။\n\nလုပ်သင့်သည်များ: ကာကွယ်မပြောခင် နားထောင်ပါ။ အရှင်းဆုံး ဦးစားပေးအလုပ်ကို လုပ်ပါ။ ရေသောက်ပြီး ကိုယ်လက်ဆန့်ပါ။\n\nမလုပ်သင့်သည်များ: အလျင်လိုမှုကို ဒရာမာမဖြစ်စေပါနှင့်။ အိုင်ဒီယာတိုင်းနောက် မလိုက်ပါနှင့်။ အနားယူရန် အချက်ပြမှုများကို မလျစ်လျူရှုပါနှင့်။",
  },
  Earth: {
    en: "Your today reading of Love, Business, Health\n\nLove: Small reliable gestures speak louder than big promises. Business: Build from the plan you already trust. Health: Let simple routines make the day feel grounded.\n\nDos: Be present and practical. Protect your schedule. Eat and rest on time.\n\nDon'ts: Do not confuse control with care. Do not over-polish before sharing. Do not carry tension silently.",
    my: "ယနေ့ သင့် အချစ်ရေး၊ စီးပွားရေး၊ ကျန်းမာရေး ဟောစာတမ်း\n\nအချစ်ရေး: ကြီးမားသောကတိများထက် ယုံကြည်ရသော သေးငယ်သောလုပ်ရပ်များက ပိုပြောနိုင်သည်။ စီးပွားရေး: သင်ယုံကြည်ပြီးသား အစီအစဉ်ပေါ်မှ တည်ဆောက်ပါ။ ကျန်းမာရေး: ရိုးရှင်းသောနေ့စဉ်လုပ်ရိုးလုပ်စဉ်များက သင့်ကို တည်ငြိမ်စေပါစေ။\n\nလုပ်သင့်သည်များ: လက်ရှိအချိန်တွင် ရှိနေပြီး လက်တွေ့ကျပါ။ သင့်အချိန်ဇယားကို ကာကွယ်ပါ။ အချိန်မှန် စားပြီး အနားယူပါ။\n\nမလုပ်သင့်သည်များ: ထိန်းချုပ်ခြင်းကို ဂရုစိုက်ခြင်းနှင့် မရောထွေးပါနှင့်။ မမျှဝေခင် အလွန်အမင်း မပြင်ဆင်ပါနှင့်။ ဖိစီးမှုကို တိတ်တိတ်ဆိတ်ဆိတ် မသယ်ဆောင်ပါနှင့်။",
  },
  Air: {
    en: "Your today reading of Love, Business, Health\n\nLove: Say the honest thing gently and leave room for reply. Business: A useful conversation can unlock the next step. Health: Give your mind quiet space between notifications.\n\nDos: Ask one better question. Write the plan down. Breathe before switching tasks.\n\nDon'ts: Do not over-explain your feelings. Do not scatter your focus. Do not let screen noise run the day.",
    my: "ယနေ့ သင့် အချစ်ရေး၊ စီးပွားရေး၊ ကျန်းမာရေး ဟောစာတမ်း\n\nအချစ်ရေး: အမှန်တရားကို နူးညံ့စွာပြောပြီး တုံ့ပြန်ရန် နေရာချန်ထားပါ။ စီးပွားရေး: အသုံးဝင်သော စကားဝိုင်းတစ်ခုက နောက်တစ်ဆင့်ကို ဖွင့်ပေးနိုင်သည်။ ကျန်းမာရေး: အသိပေးချက်များကြားတွင် သင့်စိတ်အတွက် တိတ်ဆိတ်သောနေရာပေးပါ။\n\nလုပ်သင့်သည်များ: ပိုကောင်းသော မေးခွန်းတစ်ခုမေးပါ။ အစီအစဉ်ကို ချရေးပါ။ အလုပ်ပြောင်းမလုပ်ခင် အသက်ရှူပါ။\n\nမလုပ်သင့်သည်များ: ခံစားချက်များကို အလွန်အကျွံ မရှင်းပြပါနှင့်။ အာရုံကို မပြန့်ကျဲစေပါနှင့်။ ဖုန်း/စခရင်အသံများက တစ်နေ့တာကို မထိန်းချုပ်စေပါနှင့်။",
  },
  Water: {
    en: "Your today reading of Love, Business, Health\n\nLove: Trust what you feel, then confirm it with kind words. Business: Work near people and places that feel emotionally clear. Health: Gentle boundaries will protect your energy.\n\nDos: Name your need calmly. Follow the task with the least emotional fog. Choose soothing rituals.\n\nDon'ts: Do not absorb everyone else's mood. Do not delay because the atmosphere is imperfect. Do not skip decompression time.",
    my: "ယနေ့ သင့် အချစ်ရေး၊ စီးပွားရေး၊ ကျန်းမာရေး ဟောစာတမ်း\n\nအချစ်ရေး: သင်ခံစားရသည့်အရာကို ယုံကြည်ပြီး နူးညံ့သောစကားများဖြင့် အတည်ပြုပါ။ စီးပွားရေး: စိတ်ခံစားမှုရှင်းလင်းသော လူများနှင့်နေရာများအနီးတွင် အလုပ်လုပ်ပါ။ ကျန်းမာရေး: နူးညံ့သော စည်းမျဉ်းများက သင့်စွမ်းအားကို ကာကွယ်ပေးမည်။\n\nလုပ်သင့်သည်များ: သင့်လိုအပ်ချက်ကို အေးဆေးစွာ ပြောပါ။ စိတ်မရှုပ်ထွေးဆုံး အလုပ်ကို လိုက်လုပ်ပါ။ စိတ်အေးစေသော ရိုးရာအလေ့အကျင့်များကို ရွေးပါ။\n\nမလုပ်သင့်သည်များ: အခြားသူတိုင်း၏ စိတ်ခံစားချက်ကို မစုပ်ယူပါနှင့်။ ပတ်ဝန်းကျင်မပြည့်စုံလို့ မရွှေ့ဆိုင်းပါနှင့်။ စိတ်ဖြေလျှော့ချိန်ကို မကျော်ပါနှင့်။",
  },
};
