    ...
    <main className="cosmic-page">
      <div className="cosmic-shell">
        ...
        <nav className="fixed inset-x-0 bottom-0 z-30 mx-auto max-w-[430px] px-4 pb-4">
          <div className="grid grid-cols-4 rounded-[2rem] border border-white/15 bg-[#160d36]/95 p-2 text-center text-[0.68rem] font-black text-violet-100/65 shadow-2xl shadow-fuchsia-950/40 backdrop-blur">
            <Link href="/dashboard" className="rounded-[1.5rem] bg-amber-200/15 px-2 py-2 text-amber-100">
